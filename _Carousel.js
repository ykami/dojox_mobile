...
=====*/
	...
	// module:
	//		dojox/mobile/_Carousel
	// summary:
	//		A carousel widget that manages a list of images

	return declare("dojox.mobile._Carousel", [WidgetBase, Container, Contained], {
		// summary:
		//		A carousel widget that manages a list of images
		// description:
		...
		_createMarkup: function(/*String*/type, /*String*/props, /*String*/mixins, /*Object*/item){
			if(!type){ return ""; }
			...
			var ml = '<div class="mblCarouselSlot"' +
		...
		fillPages: function(){
			array.forEach(this.getChildren(), function(child, i){
				...
				for(var j = 0; j < this.numVisible; j++){
					...
					s += this._createMarkup(type, props, mixins, item);
				}
